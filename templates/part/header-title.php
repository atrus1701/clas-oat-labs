...
<div id="header-wrapper" class="<?php echo $responsive_overlap; ?> clearfix">
	...
	<?php if ( function_exists( 'soliloquy' ) ): ?>
		...
		<?php soliloquy( 'banner' ) ?>
	<?php else: ?>
		<div class="header-title" style="background-image:url('<?php echo $header_url; ?>'); width:<?php echo $header_width; ?>px; height:<?php echo $header_height; ?>px;">
